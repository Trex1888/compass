      ...
      <div className="shuttle-content">
        <div className="shuttle-header">
          ...
          <p>
            ...
            shuttles will stop at the Grey Lot followed by the Blue Lot. The Red
            shuttles will stop at the Employee Lot and then will stop at the Red
            Lot before returning to the terminal. Click the buttons below to
            track each live route below.
          </p>
        </div>
