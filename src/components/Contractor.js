...
const Contractor = () => {
  return (
    <div className="contractor-resources-container">
      <h1>Contractor Resources</h1>
      <h2>Construction Projects</h2>
      <p>
        The Des Moines Airport Authority aims to make partnering on construction
        projects as efficient and convenient as possible.
      </p>
      <p>
        Each project requires specific security access applications and permits.
        Work with your airport representative on acquiring the full list of
        requirements for the job your team has been awarded.
      </p>
      <p>
        ...
        <a href="https://example.com/permits-forms" className="highlight-link">
          Permits & Forms page
        </a>
        .
      </p>
