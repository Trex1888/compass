...
const Buses = () => {
  return (
    <div className="about-header">
      ...
      <p>
        Several services are offered via bus including metro transit, interstate
        bus lines, and the Heart of Iowa Regional Transit Agency which provides
        transportation throughout Polk County as well as counties surrounding
      ...
      <p>
        ...
        note, these services are off the airport campus. Cabs are available for
        transportation to the bus line dispatch centers.
      </p>
