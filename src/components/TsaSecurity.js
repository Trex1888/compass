  ...
  return (
    <div>
      <div className="about-header">
        <div className="tsa-info">
          <h1>TSA & Security</h1>
          <p>
            Des Moines International Airport’s top priority is safety. We are
            committed to ensuring all travelers and visitors are not only safe
            but have a pleasant experience traveling through the terminal.
          </p>
          <p>
            With safety as the top priority, the FAA Administrator has ordered
            the agency to take strong action against any passenger who disrupts
            or threatens the safety of a flight. Please act respectfully while
          ...
          <p>
            ...
            disabilities and medical questions may call TSA Cares at
            855-787-2227.{" "}
          ...
          <div className="tsa-info-img-container">
            <img
            ...
            <div className="button-links">
              <div className="section">
                ...
                <div className={`section-content ${idOpen ? "open" : ""}`}>
                  <p>
                    A photo ID is required for confirmation of all boarding
                    passes for travelers 18 years and over. To prove your
                    identity, either a valid driver’s license or a government
                    identification card that includes a photo or a physical
                    description is adequate. A U.S. passport is the best proof
                    of U.S. citizenship. Other documents to prove U.S.
                    ...
                    Birth Abroad of a Citizen of the United States. Children
                    traveling with their parents or legal guardian do NOT have
                    to show identification. People under 18 do not need
                    identification.
                  </p>
                </div>
              </div>
              <div className="section">
                ...
                >
                  <p>
                    Only ticketed passengers can pass through Security
                    Screening. All carry-on bags or packages are passed through
                    x-ray machines. There will be a visual inspection of all
                    carry-on bags and packages.
                  </p>
                  <p>
                    ...
                    recommended that passengers arrive 90 minutes to 2 hours
                    before departure for all flights, on time, and delayed.
                  </p>
                </div>
              </div>
            </div>
