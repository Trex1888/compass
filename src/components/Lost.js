...
const Lost = ({ scrollToSection, openPopup }) => {
  ...
  return (
    <div className="about-header">
      ...
      <p>
        If your item was lost at the Airport or TSA Checkpoint, please complete
        a{" "}
        <Link to="/traveler-info/lost-and-found/lost-item-report">
          Lost Item Report
        </Link>{" "}
        and you will be notified by the Des Moines Airport Authority if the item
        is found.
      </p>
      ...
      <ul>
        <li>
          The following items will be disposed of immediately: food and beverage
          items; all items related to vaping and smoking; and items deemed to be
          unsanitary.
        </li>
        <li>
        ...
        <li>
          Any items which could be designated as weapons or drugs will be turned
          over to the Des Moines Police Department.
        </li>
        <li>
        ...
        <li>
          The Des Moines Airport Authority is not responsible for any damages to
          the item or shipping charges incurred in sending the item to the
          rightful owner.
        </li>
      </ul>
      <div>
