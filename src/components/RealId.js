    ...
    <div className="about-header">
      <div className="real-container">
        ...
        <p>
          ...
          screening and potential delays. This means that all travelers will
          need to have the REAL ID designation (gold star) on their driver's
          license or identification card or travel with a passport as of May 7,
          2025.
        </p>
        ...
        <p>
          *Travelers should ensure they bring their physical ID in the event it
          is needed at the DSM security checkpoint or at other airports on the
          travel itinerary.
        </p>
        <h2 style={{ fontWeight: "600", color: "#d96e2d" }}>
