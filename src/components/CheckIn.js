...
const CheckIn = ({ scrollToSection, openPopup }) => {
  ...
  return (
    <div className="about-containe1">
      <h1>Check-in Information</h1>
      <p>
        Check-in for most airlines begins at least 24-hours before the departing
        flight. Passengers can check-in online, at the airport ticketing kiosks
        (except for Allegiant), or at the airline ticket counter.
      </p>
      <p>
        ...
        for luggage. If you plan to use carry-on luggage only, be sure to check
        with your airline on the size and weight allowance and any associated
        fees with carry-on luggage. When traveling around holidays, it is
        suggested that additional time for ticketing and screening is allowed.
      </p>
      <p>
      ...
      <div className="cancellations-section">
        ...
        <p>
          Contact your airline as soon as possible when an originating flight or
          connection is canceled or delayed. Your airline will work with you to
          reschedule your flight. Any related ticketing charges are based on
