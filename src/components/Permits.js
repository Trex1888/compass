    ...
    <div>
      <div className="about-header">
        ...
        <div className="permits-header">
          ...
          <h3 style={{ color: "#be5a0e", fontWeight: 500 }}>
          ...
          <p>
            ...
            applications forms to include (1) the Airport Permit Application
            Form (PER-PUB-00-900) and (2) the appropriate form attachment from
            the options below.
          </p>
